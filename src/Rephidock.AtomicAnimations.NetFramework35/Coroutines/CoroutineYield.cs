...
public class CoroutineYield {
	...
	public static CoroutineYield SleepUntil(TimeSpan delay) => new CoroutineYield() { WaitUntil = delay };
	...
	public static CoroutineYield SleepUntilTrue(Func<bool> predicate) => new CoroutineYield() { WaitUntilPredicate = predicate };
