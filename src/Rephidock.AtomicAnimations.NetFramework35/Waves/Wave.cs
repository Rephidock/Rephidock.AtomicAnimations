...
public class Wave {
	...
	/// </para>
	/// </summary>
	public ReadOnlyCollection<EasingCurve> Curves { get; }
	...
	/// </para>
	/// </summary>
	public ReadOnlyCollection<float> CurveDestinations { get; }
	...
	/// The value at the gap is the end value of the last segment contributing to the gap.
	/// </para>
	/// </summary>
	public ReadOnlyCollection<float> CurveHorizontalEnds { get; }
	...
	public float Width => CurveHorizontalEnds[CurveHorizontalEnds.Count - 1];

	/// <summary>The value the wave ends at.</summary>
	public float EndValue => CurveDestinations[CurveHorizontalEnds.Count - 1];
	...
	internal Wave(
		...
		StartValue = start;
		Curves = curves.ToArray().AsReadOnly();
		CurveDestinations = destinations.ToArray().AsReadOnly();
		CurveHorizontalEnds = ends.ToArray().AsReadOnly();
	...
	/// depending on the bound breached.
	/// </para>
	/// </summary>
	/// <remarks>
